...
parseTopFunctionDeclaration = do
  ...
  let (params, kwargs, kwargsType, otherKwargs) =
        List.foldl
...
parseTopExternalFunction = do
  ...
  let finalParams = params <> [HLIR.MkAnnotation "kwargs" (HLIR.MkTyRecord kwargsType)]
